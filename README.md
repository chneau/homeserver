...
```bash
docker run --restart=always -d --name traefik -p 8080:8080 -p 80:80 -v ~/docker/traefik.yml:/etc/traefik/traefik.yml -v /var/run/docker.sock:/var/run/docker.sock:ro traefik:v2.2
